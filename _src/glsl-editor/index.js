...
app.setAttribute("v-scope", "");
app.setAttribute("v-on:vue:mounted", "mounted");

function runApp(state, vertexShader, fragmentShader) {
...
PetiteVue
    .createApp({
        ...
        mounted() {
            ...
            runApp(this.state, this.editors[0].view.state.doc.toString(),
